...
if __name__ == '__main__':
    ...
    TRAINED_MODEL_PATH = "/data/yeongjoon/AICONNECT/jaeha_code/results/train/Efficientb4_20211006163747/best.pt"
    # TRAINED_MODEL_PATH = "./results/train/Efficientb4_20211005185152/best.pt"
